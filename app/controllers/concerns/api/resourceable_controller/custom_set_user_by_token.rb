##
# adapted so it doesn't override resource_* methods
# which are part of inherited resources' protocol
# original: https://github.com/lynndylanhurley/devise_token_auth/blob/v0.1.40/app/controllers/devise_token_auth/concerns/set_user_by_token.rb
module Api
  class ResourceableController < InheritedResources::Base
    module CustomSetUserByToken
      ...
      def set_user_by_token(mapping=nil)
        ...
        rc = get_devise_resource_class(mapping)
      ...
      def get_devise_resource_name
        'User'
      end

      def get_devise_resource_class(m=nil)
        if m
          mapping = Devise.mappings[m]
        else
          mapping = Devise.mappings[get_devise_resource_name] || Devise.mappings.values.first
        end
