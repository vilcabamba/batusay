...
* [api/events/songs/index.md](api/events/songs/index.md)
...
* [api/events/tasks/destroy.md](api/events/tasks/destroy.md)
 * [DELETE /api/events/:event_id/tasks/:id](api/events/tasks/destroy.md#delete-apieventsevent_idtasksid)
...
* [api/events/tasks/update.md](api/events/tasks/update.md)
 * [PUT /api/events/:event_id/tasks/:id](api/events/tasks/update.md#put-apieventsevent_idtasksid)
